...
namespace ContentReportBuilder.Models.ElementModels
{
    ...
    public class TableElementModel : DocumentModelElement
    {
        ...
        public TableElementModel(TableData data, Dictionary<int, IExcelElementStyle> colStyle = null, IWordElementStyle defaultWordStyle = null, IExcelElementStyle defaultExcelStyle = null) :
