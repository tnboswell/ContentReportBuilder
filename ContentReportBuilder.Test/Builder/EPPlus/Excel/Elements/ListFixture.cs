...
namespace ContentReportBuilder.EPPlus.Builder.Excel.Elements
{
    ...
    public class ListFixture
    {
        ...
        private ExcelList _SystemUnderTest;
        public ExcelList SystemUnderTest
        {
            get
            {
                if (_SystemUnderTest == null)
                {
                    _SystemUnderTest = new ExcelList();
                }
        ...
        public void List_Unordered_Stream_Basic()
        {
            ...
            var docType = DocumentBuilderType.Excel;
            IDocumentDirector director = new ContentReportBuilder.EPPlus.DocumentDirector();
            var docMeta = new DocumentMetaData("ListUnordereddBasicStream", new List<string> { "Troy Boswell" });
            docMeta.Path = TestConstants.OUTPUT_FILE;
            string sectionTitle = "List Basic Section";
            var docModel = TestData.ListBasic(docType, docMeta, sectionTitle, ordered);
            string errorMsg;
